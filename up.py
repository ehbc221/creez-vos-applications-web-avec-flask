...
DOSSIER_UPS = '/var/www/html/openclassrooms-creez-vos-applications-web-avec-flask/ups/'
        ...
        if request.form['pw'] == 'up': # on vérifie que le mot de passe est bon
            ...
            if f: # on vérifie qu'un fichier a bien été envoyé
                if extension_ok(f.filename): # on vérifie que son extension est valide
                    ...
                    flash(u'Image envoyée ! Voici <a href="{lien}">son lien</a>.'.format(
                        lien=url_for('upped', nom=nom)), 'suc')
                else:
